...
export default function LoadingPage() {
  return (
     <div className="flex flex-col w-full items-center gap-4 container mx-auto mt-4">
          ...
          {[1, 2, 3, 4].map((room) => (
               <div className="flex justify-between items-center gap-8 w-[340px] md:w-full md:max-w-6xl border-2 border-gray-100 dark:border-dark-2 rounded-md p-2" key={room}>
