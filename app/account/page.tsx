     ...
     return (
          <div className="flex flex-col gap-4 w-full md:container md:mx-auto px-4 md:px-0">
               ...
               <div className="flex flex-col md:flex-row gap-4 w-full">
                    <Link href="/rooms/booked" className="h3 flex-center shadow-md rounded-lg py-6 md:w-1/2 md:py-12 bg-purple-2 dark:bg-dark-3">
                         Booked Rooms
                    </Link>
                    <Link href="/rooms/rented" className="h3 flex-center shadow-md rounded-lg py-6 md:w-1/2 md:py-12 bg-purple-2 dark:bg-dark-3">
                         Rented Rooms
                    </Link>
               </div>
          </div>
